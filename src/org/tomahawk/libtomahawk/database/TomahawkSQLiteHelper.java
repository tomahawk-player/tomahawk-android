...
public class TomahawkSQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_USERPLAYLISTS = "CREATE TABLE `" + TABLE_USERPLAYLISTS + "` (  `"
            + USERPLAYLISTS_COLUMN_ID + "` INTEGER PRIMARY KEY AUTOINCREMENT ,  `" + USERPLAYLISTS_COLUMN_NAME
            + "` TEXT , `" + USERPLAYLISTS_COLUMN_CURRENTTRACKINDEX + "` INTEGER );";
    private static final String CREATE_TABLE_ALBUMS = "CREATE TABLE `" + TABLE_ALBUMS + "` (  `" + ALBUMS_COLUMN_ID
            + "` INTEGER PRIMARY KEY AUTOINCREMENT ,  `" + ALBUMS_COLUMN_NAME + "` TEXT , `" + ALBUMS_COLUMN_ALBUMART
            + "` TEXT , `" + ALBUMS_COLUMN_FIRSTYEAR + "` INTEGER, `" + ALBUMS_COLUMN_LASTYEAR + "` INTEGER );";
    private static final String CREATE_TABLE_TRACKS = "CREATE TABLE `" + TABLE_TRACKS + "` (  `" + TRACKS_COLUMN_ID
            + "` INTEGER PRIMARY KEY AUTOINCREMENT , `" + TRACKS_COLUMN_IDUSERPLAYLISTS + "` INTEGER ,  `"
            + TRACKS_COLUMN_TRACKNAME + "` TEXT ,  `" + TRACKS_COLUMN_IDALBUMS + "` INTEGER ,  `"
            + TRACKS_COLUMN_ARTISTNAME + "` TEXT ,   `" + TRACKS_COLUMN_PATH + "` TEXT , `" + TRACKS_COLUMN_BITRATE
            + "` INTEGER , `" + TRACKS_COLUMN_DURATION + "` INTEGER, `" + TRACKS_COLUMN_SIZE + "` INTEGER, `"
            + TRACKS_COLUMN_TRACKNUMBER + "` INTEGER, `" + TRACKS_COLUMN_YEAR + "` INTEGER, `"
            + TRACKS_COLUMN_RESOLVERID + "` INTEGER, `" + TRACKS_COLUMN_LINKURL + "` TEXT, `"
            + TRACKS_COLUMN_PURCHASEURL + "` TEXT, `" + TRACKS_COLUMN_SCORE + "` REAL, FOREIGN KEY (`"
            + TRACKS_COLUMN_IDUSERPLAYLISTS + "`) REFERENCES `" + TABLE_USERPLAYLISTS + "` (`"
            + USERPLAYLISTS_COLUMN_ID + "`), FOREIGN KEY (`" + TRACKS_COLUMN_IDALBUMS + "`) REFERENCES `"
            + TABLE_ALBUMS + "` (`" + ALBUMS_COLUMN_ID + "`));";
