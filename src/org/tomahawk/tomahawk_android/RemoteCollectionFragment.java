...
public class RemoteCollectionFragment extends SherlockListFragment implements OnItemClickListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mRemoteCollectionAdapter = new ArrayAdapter<String>(getActivity(), R.layout.single_line_list_menu, R.id.single_line_list_menu_textview, getResources().getStringArray(
                R.array.remote_collection_menu_items));
